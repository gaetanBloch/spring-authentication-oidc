...
import fr.keyconsulting.geode.authentication.domain.object.authentication.Roles;
import fr.keyconsulting.geode.authentication.domain.object.authentication.Username;
...
public class Account {
  ...
  public interface AccountRolesBuilder {
    ...
    default AccountOptionalFieldBuilder roles(Collection<String> roles) {
      ...
      return roles(
        new Roles(roles.stream().map(Role::from).collect(Collectors.toUnmodifiableSet()))
      );
    }
  }
