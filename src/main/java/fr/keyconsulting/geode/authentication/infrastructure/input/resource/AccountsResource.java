package fr.keyconsulting.geode.authentication.infrastructure.input.resource;

import fr.keyconsulting.geode.authentication.application.account.AccountsApplicationService;
import fr.keyconsulting.geode.authentication.infrastructure.input.dto.AccountDto;
...
class AccountsResource {
  ...
  ResponseEntity<AccountDto> getAuthenticatedUserAccount() {
    return accounts
